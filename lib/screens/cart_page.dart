...
Widget _buildTextFormField({
 ...
 void _handleCheckout() {
  ...
  // ✅ Clear the cart immediately after booking
  widget.onClearCart();
  ...
  // ✅ Optionally go back to home or booking list
  widget.onNavigate(PageType.bookings);
}
        ...
        child: Center(
          child: ConstrainedBox(
            constraints: const BoxConstraints(
              maxWidth: 500, // ✅ prevents form from being too wide
              minWidth: 300, // ✅ prevents form from being too narrow
            ),
            child: Form(
              key: _formKey,
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  _buildSummaryRow('Total Price:', '₱${_totalPrice.toStringAsFixed(0)}'),
